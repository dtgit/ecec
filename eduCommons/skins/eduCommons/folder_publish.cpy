...
##parameters=workflow_action=None, paths=[], comment='No comment', expiration_date=None, effective_date=None, include_children=False, recurse_level=0
...
if recurse_level == 0:
    context.restrictedTraverse('search_view').changeStateEvent(context, workflow_action, bulkChange=True, initial_state=None)
