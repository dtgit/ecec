...
##parameters=workflow_action=None, comment='', effective_date=None, expiration_date=None, bulkChange=False, *args
...
initial_state = context.portal_workflow.getInfoFor(context, 'review_state')
...
if not bulkChange:
    context.restrictedTraverse('search_view').changeStateEvent(context, workflow_action, bulkChange, initial_state)
